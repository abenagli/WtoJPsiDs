...
# with command line options: WToJPsiDsToMuMuDs_13TeV_TuneCUETP8M1_cfi --mc --eventcontent RAWSIM --pileup NoPileUp --datatier GEN-SIM-RAW --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step GEN,SIM,DIGI,L1,DIGI2RAW,HLT:@frozen2016 --era Run2_2016 --fileout file:step1.root --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Summer16: Pythia8+EvtGen130 generation of W --> J/Psi Ds --> mu+mu- Ds, 13TeV, Tune CUETP8M1'),
    name = cms.untracked.string('$Source: Configuration/Generator/python/WToJPsiDsToMuMuDs_13TeV_TuneCUETP8M1_cfi.py.py $'),
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            user_decay_file = cms.vstring('GeneratorInterface/ExternalDecays/data/W_to_JPsi_Ds_to_mumu_Ds.dec')
        ),
